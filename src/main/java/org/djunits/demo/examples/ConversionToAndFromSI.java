...
public final class ConversionToAndFromSI implements UNITS
{
    ...
    public static void main(final String[] args)
    {
        ...
        System.out.println("length in METER is " + length.toString(Length.Unit.m)); // prints 1.230+05m
        ...
        System.out.println("length + delta in km is " + (length.add(delta)).toString(Length.Unit.m)); 
        // prints 5.253e+05m
    }
}
