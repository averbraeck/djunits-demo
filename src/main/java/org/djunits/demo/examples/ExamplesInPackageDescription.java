...
public final class ExamplesInPackageDescription {
	...
	public static void main(final String[] args) throws ValueRuntimeException, UnitException {
		...
		AbsoluteTemperatureVector tv1 = new AbsoluteTemperatureVector(new double[] { 273.15, 290.4, 280.5, 279.1 },
				AbsoluteTemperatureUnit.KELVIN, StorageType.DENSE);
		System.out.println(tv1);
		// AbsoluteTemperatureVector tv2 = SIVector.instantiate(new double[] { 273.15,
		// 290.4, 280.5, 279.1 },
		...
		FloatAreaVector fv = new FloatAreaVector(values, AreaUnit.SQUARE_KILOMETER, StorageType.SPARSE);
		FloatAreaVector fv2 = fv.mutable().neg();
		System.out.println(fv);
		System.out.println(fv2);
		FloatSIVector fsi = new FloatSIVector(values, SIUnit.of("kgm/As"), StorageType.SPARSE);
