...
public class FormatDemo
{
    ...
    public static void main(final String[] args)
    {
        ...
        System.out.println(l.format(QuantityFormat.defaults().setWidth(10).setGroupingSeparator(true)));
        ...
        System.out.println(l.format(QuantityFormat.defaults().setWidth(12).setGroupingSeparator(true)));
        System.out.println(l.format(QuantityFormat.defaults().setWidth(12).setGroupingSeparator(false)));
        System.out.println(
        ...
        System.out.println(v3.format(VectorFormat.Col.defaults()));

        System.out.println();
        var v4 = v3.transpose();
        System.out.println(v4
                .format(VectorFormat.Row.defaults().setDisplayUnit(Area.Unit.cm2).setFixedFloat().setWidth(1).setDecimals(3)));

        System.out.println();

        var t = new Temperature(20.0, "degC");
        System.out.println(t.format(QuantityFormat.defaults().setDisplay()));
        System.out.println(t.format(QuantityFormat.defaults().setTextual()));
        System.out.println(t.format(QuantityFormat.defaults().setDisplay().setPrintReference()
