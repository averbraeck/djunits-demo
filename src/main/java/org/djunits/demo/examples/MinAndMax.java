 ...
 * <p>
 * Copyright (c) 2013-2023 Delft University of Technology, PO Box 5, 2600 AA,
...
public final class MinAndMax {
	...
	public static void main(final String[] args) throws ValueRuntimeException {
		...
		SpeedVector sv = new SpeedVector(new Speed[] { s1, s2, s3, s4 }, SpeedUnit.METER_PER_SECOND);
		...
		FloatAccelerationVector fav = new FloatAccelerationVector(new FloatAcceleration[] { fa1, fa2, fa3, fa4 },
		...
		DurationVector tv = new DurationVector(new Duration[] { t1, t2, t3, t4 }, DurationUnit.MINUTE);
		...
		FloatDirectionVector fdv = new FloatDirectionVector(new FloatDirection[] { fd1, fd2, fd3, fd4 },
		...
		DimensionlessVector dv = new DimensionlessVector(new Dimensionless[] { d1, d2, d3, d4 }, DimensionlessUnit.SI);
