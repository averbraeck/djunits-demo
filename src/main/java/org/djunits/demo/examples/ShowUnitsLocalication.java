...
/**
 * Show all the units and some localization examples.
 * <p>
 ...
 */
public final class ShowUnitsLocalication
{
    /** */
    private ShowUnitsLocalication()
    {
        printUnits();
        length();
        temp();
    ...
    private void printUnits()
    {
        ...
        {
            Map<String, Unit<?, ?>> inner = entry.getValue();
