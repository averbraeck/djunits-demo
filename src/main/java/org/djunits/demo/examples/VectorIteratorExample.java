...
public final class VectorIteratorExample {
	...
	private static void showFloatIterator() throws ValueRuntimeException {
		...
		svsMap.put(5, s3);
		svsMap.put(7, s4);
		FloatSpeedVector svs = new FloatSpeedVector(svsMap, 10, SpeedUnit.METER_PER_SECOND, StorageType.SPARSE);
		...
		tvsMap.put(5, t3);
		tvsMap.put(7, t4);
		FloatTimeVector tvs = new FloatTimeVector(tvsMap, 10, TimeUnit.BASE_SECOND, StorageType.SPARSE);
